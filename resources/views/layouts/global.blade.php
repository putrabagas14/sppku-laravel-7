...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('siswa.index')}}"><i class="fa fa-angle-double-right"></i> Entri Siswa</a></li>
            <li><a href="{{route('kelas.index')}}"><i class="fa fa-angle-double-right"></i> Entri Kelas </a></li>
            <li><a href="{{route('petugas.index')}}"><i class="fa fa-angle-double-right"></i> Entri Petugas </a></li>
            <li><a href="{{route('spp.index')}}"><i class="fa fa-angle-double-right"></i> SPP </a></li>
          </ul>
        </li>
        <li><a href="{{route('user.index')}}"><i class="fa fa-clipboard"></i>User</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020-2021 <a href="https://adminlte.io">Almsaeed Studio</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- ChartJS -->
<script src="{{asset('back-end/bower_components/chart.js/Chart.js')}}"></script>
